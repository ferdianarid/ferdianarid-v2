...
id: 5
name: Salespack
projectUrl: https://salespack.vercel.app
category: Packaging Business
author: Ferdian Ahmad R
role: Freelance Frontend
imageUrl: 'salespack'
description: Salespack has access to a large pool of candidates through our personal database system. Our database provides the foundation for our applicant searches ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['Packaging', 'Business', 'Solution', 'Landing Page']
---
