...
id: 8
name: Timvoice
projectUrl: https://invoice-fawn.vercel.app
category: Landing Page
author: Ferdian Ahmad R
role: Freelance Frontend
imageUrl: 'timvoice'
description: Timvoice App has access to a large pool of candidates through our personal database system. Our database provides the foundation for our applicant searches ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['Timvoice', 'Invoice App', 'Solution', 'Landing Page']
---
