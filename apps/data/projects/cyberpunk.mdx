...
id: 7
name: Cyberpunk
projectUrl: https://cyberpunks.vercel.app
category: Landing Page
author: Ferdian Ahmad R
role: Freelance Frontend
imageUrl: 'cyberpunk'
description: Cyberpunk has access to a large pool of candidates through our personal database system. Our database provides the foundation for our applicant searches ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['Cyberpunk', 'Apps', 'Solution', 'Landing Page']
---
