...
const SignUp: NextPage = () => {
    ...
    return (
        <Fragment>
            ...
            <AuthLayout>
                <div className="w-full bg-neutral-10 dark:bg-primary-pressed text-primary-pressed dark:text-neutral-10 px-6 md:px-24 flex pb-10 flex-col md:flex-row justify-between md:justify-between md:space-x-16 items-center">
